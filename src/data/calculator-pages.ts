...
const bathroom: CalculatorPageData = {
  ...
  affiliates: [
    { title: 'Mildew-Resistant Paint', description: 'Bathroom-grade paint that resists mold and mildew in high-humidity environments.', icon: 'paint', link: 'https://www.amazon.com/s?k=mildew+resistant+bathroom+paint&tag=probuild20-20', cta: 'Shop Bathroom Paint' },
    { title: 'Bathroom Primer', description: 'Moisture-blocking primer designed for bathrooms and high-humidity areas.', icon: 'primer', link: 'https://www.amazon.com/s?k=moisture+blocking+primer+bathroom&tag=probuild20-20', cta: 'Shop Primer' },
    { title: 'Paint Supplies', description: 'Rollers, brushes, tape, and drop cloths for a professional bathroom finish.', icon: 'brush', link: 'https://www.amazon.com/s?k=paint+supplies+kit&tag=probuild20-20', cta: 'Shop Supplies' },
  ],
};
...
const kitchen: CalculatorPageData = {
  ...
  affiliates: [
    { title: 'Scrub-Resistant Paint', description: 'Kitchen-grade paint that resists grease and cleans easily near cooking areas.', icon: 'paint', link: 'https://www.amazon.com/s?k=scrub+resistant+kitchen+paint&tag=probuild20-20', cta: 'Shop Kitchen Paint' },
    { title: 'Kitchen Primer', description: 'Adhesion primer for kitchen walls, cabinets, and high-moisture surfaces.', icon: 'primer', link: 'https://www.amazon.com/s?k=kitchen+cabinet+primer&tag=probuild20-20', cta: 'Shop Primer' },
    { title: 'Paint Supplies', description: 'Quality rollers, brushes, tape, and drop cloths for a professional finish.', icon: 'brush', link: 'https://www.amazon.com/s?k=paint+supplies+kit&tag=probuild20-20', cta: 'Shop Supplies' },
  ],
};
...
const garage: CalculatorPageData = {
  ...
  affiliates: [
    { title: 'Epoxy Floor Paint', description: 'Professional-grade epoxy coating for garage floors that resists chemicals and tire marks.', icon: 'paint', link: 'https://www.amazon.com/s?k=epoxy+garage+floor+paint&tag=probuild20-20', cta: 'Shop Floor Paint' },
    { title: 'Drywall Primer', description: 'PVA primer for new drywall in garages. Seals the surface for even paint coverage.', icon: 'primer', link: 'https://www.amazon.com/s?k=pva+drywall+primer&tag=probuild20-20', cta: 'Shop Primer' },
    { title: 'Paint Supplies', description: 'Heavy-duty rollers, brushes, and trays for large garage painting projects.', icon: 'brush', link: 'https://www.amazon.com/s?k=paint+roller+kit+large&tag=probuild20-20', cta: 'Shop Supplies' },
  ],
};
...
const basement: CalculatorPageData = {
  ...
  affiliates: [
    { title: 'Waterproofing Primer', description: 'Moisture-blocking primer that seals concrete and masonry basement walls.', icon: 'primer', link: 'https://www.amazon.com/s?k=waterproofing+basement+primer&tag=probuild20-20', cta: 'Shop Primer' },
    { title: 'Mold-Resistant Paint', description: 'Basement-grade paint with built-in mold and mildew protection for below-grade walls.', icon: 'paint', link: 'https://www.amazon.com/s?k=mold+resistant+basement+paint&tag=probuild20-20', cta: 'Shop Paint' },
    { title: 'Paint Supplies', description: 'Rollers, brushes, tape, and drop cloths for basement painting projects.', icon: 'brush', link: 'https://www.amazon.com/s?k=paint+supplies+kit&tag=probuild20-20', cta: 'Shop Supplies' },
  ],
};
...
function brandPage(
  ...
  return {
    ...
    affiliates: [
      ...
      { title: 'Paint Supplies', description: 'Quality rollers, brushes, tape, and drop cloths for a professional finish.', icon: 'brush', link: 'https://www.amazon.com/s?k=paint+supplies+kit&tag=probuild20-20', cta: 'Shop Supplies' },
      { title: 'Paint Sprayers', description: 'Save time on big projects with an electric or airless paint sprayer.', icon: 'sprayer', link: 'https://www.amazon.com/s?k=paint+sprayer&tag=probuild20-20', cta: 'View Sprayers' },
    ],
...
const behr = brandPage(
  ...
  'https://www.amazon.com/s?k=behr+paint&tag=probuild20-20',
...
const sherwinWilliams = brandPage(
  ...
  'https://www.amazon.com/s?k=sherwin+williams+paint&tag=probuild20-20',
...
const benjaminMoore = brandPage(
  ...
  'https://www.amazon.com/s?k=benjamin+moore+paint&tag=probuild20-20',
...
const valspar = brandPage(
  ...
  'https://www.amazon.com/s?k=valspar+paint&tag=probuild20-20',
...
const ppg = brandPage(
  ...
  'https://www.amazon.com/s?k=ppg+paint+interior&tag=probuild20-20',
...
const glidden = brandPage(
  ...
  'https://www.amazon.com/s?k=glidden+paint+interior&tag=probuild20-20',
...
const rustOleum = brandPage(
  ...
  'https://www.amazon.com/s?k=rust-oleum+interior+paint&tag=probuild20-20',
...
const farrowAndBall = brandPage(
  ...
  'https://www.amazon.com/s?k=farrow+and+ball+paint&tag=probuild20-20',
...
function colorChangePage(
  ...
  return {
    ...
    affiliates: [
      { title: 'High-Hide Primer', description: 'Stain-blocking primer for dramatic color changes. Ensures even coverage and true color.', icon: 'primer', link: 'https://www.amazon.com/s?k=high+hide+primer+paint&tag=probuild20-20', cta: 'Shop Primer' },
      { title: 'Premium Paint', description: 'Top-rated interior paints with excellent coverage for color transitions.', icon: 'paint', link: 'https://www.amazon.com/s?k=interior+wall+paint+high+coverage&tag=probuild20-20', cta: 'Browse Paint' },
      { title: 'Paint Supplies', description: 'Quality rollers, brushes, tape, and drop cloths for a professional finish.', icon: 'brush', link: 'https://www.amazon.com/s?k=paint+supplies+kit&tag=probuild20-20', cta: 'Shop Supplies' },
    ],
  };
}
